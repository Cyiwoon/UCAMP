...
public final class ConnectionPool {
    ...
    public ConnectionPool( String url, String user, String password, int initialCons, int maxCons,
    ...
    public String reportStatus() {
        ...
        String report = "»ç¿ëÁß : " + used.size() + "       free : " + free.size();
        return report;
    }
    ...
    public synchronized void closeAll() {
        ...
        while ( cons.hasMoreElements() ) {
            ...
            try {
                ...
                // The Connection appears to be broken anyway, so we will ignore
                // it
            }
        }
